...
int max(int , int );
int min(int , int );
void drawRectangle (int16_t , int16_t , uint8_t , uint8_t , uint8_t );
void drawFastVLine (int16_t , int16_t , uint8_t , uint8_t );
void drawFastHLine(int16_t , int16_t , uint8_t , bool );
void fillRectangle(int16_t , int16_t , uint8_t , uint8_t , bool );
    /**
